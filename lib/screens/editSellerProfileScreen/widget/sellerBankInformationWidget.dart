...
class SellerBankInformationWidget extends StatefulWidget {
  ...
  @override
  State<SellerBankInformationWidget> createState() => SellerBankInformationWidgetState();
}

class SellerBankInformationWidgetState extends State<SellerBankInformationWidget> {
  ...
  void initState() {
    ...
    edtAccountNumber = TextEditingController(
      text: widget.personalData[ApiAndParams.account_number] == null
